    ...
    >
      <AnimatePresence>
        {listNumber !== 0 && listNumber === section && (
          ...
          >
            <MdKeyboardDoubleArrowUp className="h-12 w-12 opacity-20 hover:opacity-100 transition-opacity animate-bounce" />
          </motion.button>
        )}
      </AnimatePresence>
      {children}
      <AnimatePresence>
        {listNumber !== data.pages - 1 && listNumber === section && (
          ...
          >
            <MdKeyboardDoubleArrowDown className="h-12 w-12 opacity-20 hover:opacity-100 transition-opacity animate-bounce" />
          </motion.button>
        )}
      </AnimatePresence>
    </section>
