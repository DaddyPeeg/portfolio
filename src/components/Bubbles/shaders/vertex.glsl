...
void main() {
  ...
  float displacement = cnoise1(vec4(normal * uFrequency, uTime)) * 0.676666;

  // float displacement = cnoise2(vec4(normal * uFrequency * 2.0, uTime), vec4(normal * uFrequency, uTime * 0.4)) * 0.8;
